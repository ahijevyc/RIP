...
c                                                                     c
     ...
     &   prs,ght,ter,sfp,lhide,idiffflag,field,
...
c
     ...
     &   ght(miy,mjx,mkzh),ter(miy,mjx),sfp(miy,mjx),prs(miy,mjx,mkzh)
...
c
c      First, find pressure level that is closest to delta-p above
c      the surface.  The temperature at this level will be
c      used to define the subterranean temperature profile.  
c
         ptarget=psurf-150.
         dpmin=1.e4
         do k=1,mkzh
