...
c*********************************************************************c
c                                                                     c
      subroutine parcel_tendncy(xmap,uuu,vvv,cor,theta,prs,pv,
     &   www,ght,qv,miy,mjx,mkzh,xtime)
...
c
 ...
 270  continue
      ...
      call capecalc3d(prs,tmk3,qv,ght,ter,prsf,cape,cin,
     &   miy,mjx,mkzh,0)
      zmsemax = cin(:,:,mkzh-8)
      tl = cin(:,:,mkzh-4)
      tm = cin(:,:,mkzh-10)
      ...
      do 271 i=3,miy-2
       ...
       dt=0.
       dqv=0.
c       call tlift(t1,dtmk,zmsemax(i,j),p1,q1,dqv,tl,tm,i,j,kk,mkzh,kb)
       kk=kmsemax(i,j)
       do 274 ii=ibeg,iend
       do 274 jj=jbeg,jend
