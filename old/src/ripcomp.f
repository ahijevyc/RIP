...
c      dimension ihrip(32),rhrip(32),fullsigma(128),halfsigma(128)
c      character chrip(64)*64,vardesc*64,plchun*24
      ...
      enddo
      do i=1,128
         if (fullsigma2(i).ne.fullsigma(i)) then
            print*,'fullsigma(',i,') not the same.'
            print*,'fullsigma(',i,') (1,2)=',fullsigma(i),fullsigma2(i)
         endif
      enddo
      do i=1,128
         if (halfsigma2(i).ne.halfsigma(i)) then
            print*,'halfsigma(',i,') not the same.'
            print*,'halfsigma(',i,') (1,2)=',halfsigma(i),halfsigma2(i)
         endif
      enddo
      do i=1,64
