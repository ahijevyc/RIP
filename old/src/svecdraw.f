...
c*********************************************************************c
c                                                                     c
      subroutine svecdraw(ilinw,sigh,prs,rslcg,icolr,icdwk,
     &   work1,work2,ipl,rslcgprv,unorth,vnorth,rvvms,prssou,cfulb,
     &   lhodo,ins,flminsou,frmaxsou,fbminsou,ftmaxsou,icomax,
     &   maxpl,miy,mjx,mkzh)
c
      dimension sigh(mkzh),prs(miy,mjx,mkzh),
