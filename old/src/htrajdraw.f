...
c*********************************************************************c
c                                                                     c
      subroutine htrajdraw(ilinw,vc3d,pstx,sigh,ixwin,iywin,ifltrack,
...
c
     ...
     &   rtjti(maxpl),rstrm(2,maxpl),rrota(maxpl)
...
c
     ...
     &   ichanged(maxtraj)
      ...
      character trlab*4, leglablow*16,leglabhigh*16,str*32
c
