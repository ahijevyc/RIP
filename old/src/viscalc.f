...
c   lowest sigma layer, from qcw, qra, qci, and qsn.  At each grid point,
c   the routine assigns values of total liq. eq. precip, total liq.
c   equiv. cloud, rain, snow, cloud water, and cloud ice, based on
c   the value of iice.
c
c   If iice=0:
c
